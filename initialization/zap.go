...
func (z *_zap) GetEncoderCore(l zapcore.Level, level zap.LevelEnablerFunc) zapcore.Core {
	writer, err := logger.FileRotateLogs.GetWriteSyncer(l.String()) // 使用file-rotatelogs进行日志分割
	if err != nil {
...
func InitializeZap() {
	...
	global.SERVER_LOG.Info("server run success on ", zap.String("zap_log", "zap_log"))
}
