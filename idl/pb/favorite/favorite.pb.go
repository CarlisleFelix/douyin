...
type DouyinIsFavoriteRequest struct {
	...
	VideoId *int64 `protobuf:"varint,2,req,name=video_id,json=videoId" json:"video_id,omitempty"`
}
...
type DouyinIsFavoriteResponse struct {
	...
	IsFavorite *bool `protobuf:"varint,1,req,name=isFavorite" json:"isFavorite,omitempty"`
}
...
type DouyinFavoriteActionRequest struct {
	...
	UserId     *int64 `protobuf:"varint,1,req,name=user_id,json=userId" json:"user_id,omitempty"`             // 用户鉴权token
...
var file_favorite_proto_rawDesc = []byte{
	...
	0x12, 0x13, 0x64, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x2e, 0x69, 0x64, 0x6c, 0x2e, 0x66, 0x61, 0x76,
	0x6f, 0x72, 0x69, 0x74, 0x65, 0x22, 0x50, 0x0a, 0x1a, 0x64, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x5f,
	...
	0x76, 0x69, 0x64, 0x65, 0x6f, 0x49, 0x64, 0x22, 0x3d, 0x0a, 0x1b, 0x64, 0x6f, 0x75, 0x79, 0x69,
	0x6e, 0x5f, 0x69, 0x73, 0x5f, 0x66, 0x61, 0x76, 0x6f, 0x72, 0x69, 0x74, 0x65, 0x5f, 0x72, 0x65,
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x1e, 0x0a, 0x0a, 0x69, 0x73, 0x46, 0x61, 0x76, 0x6f,
	0x72, 0x69, 0x74, 0x65, 0x18, 0x01, 0x20, 0x02, 0x28, 0x08, 0x52, 0x0a, 0x69, 0x73, 0x46, 0x61,
	0x76, 0x6f, 0x72, 0x69, 0x74, 0x65, 0x22, 0x75, 0x0a, 0x1e, 0x64, 0x6f, 0x75, 0x79, 0x69, 0x6e,
	...
	0x03, 0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x22, 0x9a, 0x01, 0x0a, 0x1d, 0x64, 0x6f,
	...
	0x1a, 0x2e, 0x64, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x2e, 0x69, 0x64, 0x6c, 0x2e, 0x66, 0x61, 0x76,
	0x6f, 0x72, 0x69, 0x74, 0x65, 0x2e, 0x56, 0x69, 0x64, 0x65, 0x6f, 0x52, 0x09, 0x76, 0x69, 0x64,
	0x65, 0x6f, 0x4c, 0x69, 0x73, 0x74, 0x22, 0x85, 0x02, 0x0a, 0x05, 0x56, 0x69, 0x64, 0x65, 0x6f,
	0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x02, 0x28, 0x03, 0x52, 0x02, 0x69, 0x64,
	0x12, 0x31, 0x0a, 0x06, 0x61, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x18, 0x02, 0x20, 0x02, 0x28, 0x0b,
	0x32, 0x19, 0x2e, 0x64, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x2e, 0x69, 0x64, 0x6c, 0x2e, 0x66, 0x61,
	...
	,
	...
	0x2e, 0x64, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x2e, 0x69, 0x64, 0x6c, 0x2e, 0x66, 0x61, 0x76, 0x6f,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x12, 0x75, 0x0a, 0x0c, 0x46, 0x61, 0x76, 0x6f, 0x72, 0x69, 0x74, 0x65,
	0x4c, 0x69, 0x73, 0x74, 0x12, 0x31, 0x2e, 0x64, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x2e, 0x69, 0x64,
	0x6c, 0x2e, 0x66, 0x61, 0x76, 0x6f, 0x72, 0x69, 0x74, 0x65, 0x2e, 0x64, 0x6f, 0x75, 0x79, 0x69,
	...
	0x2e, 0x69, 0x64, 0x6c, 0x2e, 0x66, 0x61, 0x76, 0x6f, 0x72, 0x69, 0x74, 0x65, 0x2e, 0x64, 0x6f,
	0x75, 0x79, 0x69, 0x6e, 0x5f, 0x66, 0x61, 0x76, 0x6f, 0x72, 0x69, 0x74, 0x65, 0x5f, 0x6c, 0x69,
	0x73, 0x74, 0x5f, 0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x0b, 0x5a, 0x09, 0x66,
	0x61, 0x76, 0x6f, 0x72, 0x69, 0x74, 0x65, 0x2f,
}
...
var file_favorite_proto_goTypes = []interface{}{
	(*DouyinIsFavoriteRequest)(nil),      // 0: douyin.idl.favorite.douyin_is_favorite_request
	(*DouyinIsFavoriteResponse)(nil),     // 1: douyin.idl.favorite.douyin_is_favorite_response
	(*DouyinFavoriteActionRequest)(nil),  // 2: douyin.idl.favorite.douyin_favorite_action_request
	(*DouyinFavoriteActionResponse)(nil), // 3: douyin.idl.favorite.douyin_favorite_action_response
	(*DouyinFavoriteListRequest)(nil),    // 4: douyin.idl.favorite.douyin_favorite_list_request
	(*DouyinFavoriteListResponse)(nil),   // 5: douyin.idl.favorite.douyin_favorite_list_response
	(*Video)(nil),                        // 6: douyin.idl.favorite.Video
	(*User)(nil),                         // 7: douyin.idl.favorite.User
}
var file_favorite_proto_depIdxs = []int32{
	6, // 0: douyin.idl.favorite.douyin_favorite_list_response.video_list:type_name -> douyin.idl.favorite.Video
	7, // 1: douyin.idl.favorite.Video.author:type_name -> douyin.idl.favorite.User
	0, // 2: douyin.idl.favorite.FavoriteService.IsFavorite:input_type -> douyin.idl.favorite.douyin_is_favorite_request
	2, // 3: douyin.idl.favorite.FavoriteService.FavoriteAction:input_type -> douyin.idl.favorite.douyin_favorite_action_request
	4, // 4: douyin.idl.favorite.FavoriteService.FavoriteList:input_type -> douyin.idl.favorite.douyin_favorite_list_request
	1, // 5: douyin.idl.favorite.FavoriteService.IsFavorite:output_type -> douyin.idl.favorite.douyin_is_favorite_response
	3, // 6: douyin.idl.favorite.FavoriteService.FavoriteAction:output_type -> douyin.idl.favorite.douyin_favorite_action_response
	5, // 7: douyin.idl.favorite.FavoriteService.FavoriteList:output_type -> douyin.idl.favorite.douyin_favorite_list_response
